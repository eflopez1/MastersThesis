...
from grangercausality_new import GrangerCausality
...
import functions, grangercausality_new
copyfile(functions.__file__,saveLoc + 'functions.txt')
copyfile(grangercausality_new.__file__,saveLoc+'GrangerCausality.txt')
