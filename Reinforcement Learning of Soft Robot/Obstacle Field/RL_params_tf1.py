...
botTrainingSteps = {10:10_000_000,
                    30:50_000_000
                    }

divisor = 1 # Number of times that training will be haulted to check on progress
...
check_freq = 50_000 # After how many timesteps do we check the frequency
